...
class InputOrganism extends React.PureComponent<any, any> {
  ...
  render() {
    ...
    return (
      <div className={cx('flex flex-column justify-center align-center', className)}>
        <div
          role="button"
          ...
          className={cx('w-100 ph3 pv1 br3 flex flex-row align-start outline-0', css`
        ...
        >
          ...
          <div className="w-100 ml2 flex flex-column justify-start align-start">
            ...
            {type !== 'textarea' && (
              <input
                ...
                type={type}
                className={cx('w-100 ph2 outline-0 bn', css`
                  font-size: 0.8rem;
          ...
          {error && (
            <IconAtom
              ...
              className={cx('f3 self-center', css`color: ${COLORS.RED.NORMAL}`)}
            />
          )}
        </div>
        <div className="mt2">
          {error && (
            <TextAtom
              size="S"
              className={cx('self-center', css`color: #EB5757`)}
            >
              {error}
            </TextAtom>
          )}
