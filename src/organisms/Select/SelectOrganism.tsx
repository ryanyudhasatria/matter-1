...
const DropdownIndicator = (props: any) => components.DropdownIndicator && (
  <components.DropdownIndicator {...props}>
    <div
      className={cx("dropdown-circle br-100 bg-dark6 flex flex-column justify-center items-center", css`
        width: 32px;
        height: 32px;
      `)}>
        ...
        <div
          ...
          className={cx("w-100 pl3 pr2 pv1 br3 flex flex-row align-center outline-0", css`
            ...
            & .dropdown-circle {
              ...
              background-image: url( ${isFocus
                ? "https://s3-ap-southeast-1.amazonaws.com/kode-images/public/web-app/arrow-down-white.png"
                : "https://s3-ap-southeast-1.amazonaws.com/kode-images/public/web-app/arrow-down-black.png" } );
