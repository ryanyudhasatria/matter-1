  ...
  .add(
    ...
    <div className="flex flex-column pa4 w-100 ba b--silver">
      <HorizontalCourseCardMolecule
        ...
        // ActionButtonComponent={() => <a className={cx('f6 link dim br-pill ph3 pv2 dib white', css`background: ${COLORS.GREY.LIGHT}; color: ${COLORS.BLACK.NORMAL}`)} href="#0"><b>Lihat Course Ini</b></a> }
